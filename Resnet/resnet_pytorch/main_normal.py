...
def train(total_epoch: int = 20, mode="normal", seed=seed):
    ...
    # 各層の中間出力を記録#################################################################
    activation_1, activation_2, activation_3, activation_4 = None, None, None, None
...
def save_epoch_accuracies():
    accuracy_log, test_accuracy_log, generalization_gap, output_dir = train(total_epoch=10, mode="normal") # epoch数はここ

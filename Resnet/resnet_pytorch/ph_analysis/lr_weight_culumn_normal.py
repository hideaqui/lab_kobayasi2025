...
# for epoch in valid_epochs:
    weight_file = os.path.join(output_dir, f"epoch_{epoch}_fc_weights_normal.npy")
    ...
    # lambda がlifetimesの平均でmu がmidpointの平均
